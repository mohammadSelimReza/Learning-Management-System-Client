                ...
                <div className="collapse navbar-collapse p-3" id="sidenav">
                    <div className="navbar-nav flex-column">
                        <ul className="list-unstyled ms-n2 mb-4">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link " to={`/instructor/course/view`}> <i className='fas fa-shopping-cart me-2'></i>My Courses</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link " to='/instructor/course/create'> <i className='fas fa-plus me-2'></i>Create Course</Link>
                            </li>
                            <li className="nav-item">
