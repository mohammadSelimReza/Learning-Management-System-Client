...
function Success() {
    ...
    return (
        ...
        <>
            <BaseHeader />
            <section className="success pt-0 mh-100  position-relative overflow-hidden my-auto">
                <p>{transactionId} </p>
                <div className="container position-relative">
                    <div className="row g-5 align-items-center justify-content-center">
                        <div className="col-lg-5">
                            <h1 className="text-success">Enrollment Successful!</h1>
                            <p> Hey there, you enrollment in the 2 courses where successful, visit your <Link to='/student/course/detail' className="primary-text" href="#">My Courses</Link> page, to view the courses now.</p>
                        </div>
